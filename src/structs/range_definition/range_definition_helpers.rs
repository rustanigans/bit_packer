...
pub(super) fn get_u_from_pb<T: Shr<u32, Output=T> + Copy + NumByteConverter<T>>(pb: &mut PackedBits, zeros: u32) -> T
{
...
pub(super) fn get_vec_from_u<T: Shl<u32, Output=T> + Copy + NumByteConverter<T>>(val:T, zeros:u32) -> (Vec<u8>, usize) {
